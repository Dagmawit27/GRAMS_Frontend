...
export default function OfficerAgreementsListPage() {
  ...
  // SSE subscription for real-time UNDER_VERIFICATION notifications
  useEffect(() => {
    const session = getSession();
    ...
    const unsubscribe = sseManager.onNotification((notification) => {
      console.log("OfficerAgreementsListPage: Received SSE notification:", notification);
      if (
        ...
        console.log("OfficerAgreementsListPage: Reloading under-verification agreements...");
        setTimeout(() => {
          fetchLeaseRequests();
          setToastMessage("New agreement pending verification received!");
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-extrabold text-slate-900 tracking-tight flex items-center gap-2">
            ...
            Agreement Verifications List
          </h1>
          <p className="text-sm text-slate-500 mt-1">
            Lease agreements pending Woreda Officer verification
          </p>
        </div>
