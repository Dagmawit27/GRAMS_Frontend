...
export const TaxOfficerDashboardSkeleton: React.FC = () => {
  return (
    <div className="space-y-6 animate-in fade-in duration-100">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {[1, 2, 3, 4].map((i) => (
          <div key={i} className="bg-white border border-slate-200/90 rounded-2xl p-5 shadow-2xs space-y-3">
      ...
      {/* 2-Column Progress & Table Skeleton */}
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-5">
        ...
        <div className="lg:col-span-5 bg-white border border-slate-200/90 rounded-2xl p-5 shadow-2xs space-y-4">
          ...
          <div className="space-y-2">
            {[1, 2, 3, 4, 5].map((k) => (
              <div key={k} className="p-3 border border-slate-100 rounded-xl flex items-center justify-between">
